  ...
  return (
    <div>
      ...
      <div className="hidden md:grid grid-cols-3 gap-4">
        ...
        >
          <Image sizes="auto" priority src={image_urls[0]} fill alt={alt} />
        </div>
        <div
          name="2"
          onClick={doOpenLightBox}
          className="relative aspect-video rounded-lg overflow-hidden shadow-lg cursor-pointer"
        >
          <Image sizes="auto" priority src={image_urls[1]} fill alt={alt} />
        </div>
        <div className="relative aspect-video rounded-lg overflow-hidden shadow-lg">
          ...
          <div
            name="3"
            onClick={doOpenLightBox}
            className="absolute z-[99] left-0 top-0 h-full w-full flex items-center justify-center cursor-pointer transition-all bg-black bg-opacity-20 hover:bg-opacity-50"
          >
